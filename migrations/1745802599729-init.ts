...
export class Init1745802599729 implements MigrationInterface {
    name = 'Init1745802599729'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "jobs_failed" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL, "queue_name" character varying NOT NULL, "job_name" character varying NOT NULL, "job_id" character varying NOT NULL, "payloads" text NOT NULL, "target" character varying NOT NULL, "type_identifier" character varying NOT NULL, "job_status" character varying NOT NULL, "failed_reason" character varying NOT NULL, "is_reschedule" boolean NOT NULL DEFAULT false, "reschedule_status" character varying NOT NULL, CONSTRAINT "uq_JobFailed_job_key" UNIQUE ("job_id"), CONSTRAINT "PK_81e4f95708db6a6cec74305f733" PRIMARY KEY ("id"))`);
